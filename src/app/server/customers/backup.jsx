...
// const Page = async () => {
//     const getComponents = await useCmsData(cmsPageDetails.locale, cmsPageDetails.space, cmsPageDetails.slug);
...
//                                             {category.featured.map((data) => {
//                                                 return (
//                                                     <div className="featured-card sm:max-w-lg lg:max-w-full">
//                                                         <div>
//                                                             <h4
//                                                                 tag="h4"
//                                                                 className="text-blue-900 font-sora font-semibold tracking-wide uppercase text-xxs lg:text-xs lg:font-normal 3xl:text-sm 3xl:font-medium">
...
//                                 {category.Billing.map((record, index) => {
//                                     return <Component key={index} data={record} />;
//                                 })}
//                             </div>

//                             <div className="w-full sm:w-fit">
//                                 <button title="Sign up for free" variant="button-outline">
...
//                                 </div>
//                             </div>
//                             <div className="grid grid-cols-3 gap-10">{category.RevRec.map((data, index) => {})}</div>
...
//                                 </div>
//                             </div>
//                             <div className="grid grid-cols-3 gap-10">{category.Receivables.map((data, index) => {})}</div>
...
//                                 </div>
//                             </div>
//                             <div className="grid grid-cols-3 gap-10">{category.Retention.map((data, index) => {})}</div>
//                         </div>
